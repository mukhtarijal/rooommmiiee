{{-- resources/views/kost/premium.blade.php --}}

<x-app-layout>
    <div class="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        {{-- Judul Halaman --}}
        <h1 class="text-3xl font-bold text-gray-900 mb-6">Rekomendasi Kost Terbaik</h1>
        ...
        <div class="relative">
            <div class="swiper-container">
                <div class="swiper-wrapper">
                    ...
                    @empty
                        <p class="text-gray-600">Tidak ada kost tersedia.</p>
                    @endforelse
                </div>
            </div>
        </div>
